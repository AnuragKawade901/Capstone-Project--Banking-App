    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalaryPayments", x => x.DetailId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalaryPayments_SalaryDisbursements_SalaryDisbursementId",
                        column: x => x.SalaryDisbursementId,
                        principalTable: "SalaryDisbursements",
                        principalColumn: "SalaryDisbursementId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryPayments_SalaryDisbursementId",
                table: "SalaryPayments",
                column: "SalaryDisbursementId");
