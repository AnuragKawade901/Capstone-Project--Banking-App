...
namespace Payment_Project_AP.Service
{
    public class SalaryDisbursementService : ISalaryDisbursementService
    {
        ...
        public async Task<SalaryDisbursement> Add(SalaryDisbursement disbursement, ICollection<int> ids)
        {
            ...
            string body =
                        $"""
                        Salary Disbursement Id ({salary.SalaryDisbursementId}) has been created by {salary?.Client?.UserName ?? "an user"}.
                        with amount {salary.TotalAmount}.
                        """;
            await _emailService.SendEmailToClientAsync((int)salary?.Client?.BankUserId, subject, body);
        ...
        public async Task<SalaryDisbursement> ApproveSalaryDisbursement(int disbursementId)
        {
            ...
            int ClientAccountId = salaryDisbursement.Client.Account.AccountId;
            ...
            var processedDetails = new List<SalaryPayment>();
