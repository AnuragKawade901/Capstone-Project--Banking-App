...
namespace Payment_Project_AP.Service
{
    public class PaymentService : IPaymentService
    {
        ...
        public PaymentService(IPaymentRepository paymentRepository, ITransactionService transactionService, IAccountService accountService, IMapper mapper, CorporateBankingDBContext dBContext, IEmailService emailService)
        {
